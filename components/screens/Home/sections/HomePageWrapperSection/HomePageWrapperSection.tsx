...
export const HomePageWrapperSection = (): JSX.Element => {
  ...
  return (
    <section className="flex flex-col items-center gap-12 px-6 md:px-[140px] py-12 md:py-[100px] w-full bg-white relative">
      ...
      {/* Desktop arrows - positioned outside the text container with proper spacing */}
      <Button
        variant="default"
        size="icon"
        className="hidden md:block w-12 h-12 p-2.5 absolute top-1/2 left-[calc(50%-450px)] transform -translate-y-1/2 bg-[#081f24] rounded-[40px] border border-solid border-[#081f241a] hover:bg-[#081f24]/90"
        aria-label="Previous testimonial"
      >
        <ArrowLeftIcon className="w-5 h-5" />
      </Button>
      ...
      <Button
        variant="default"
        size="icon"
        className="hidden md:block w-12 h-12 p-2.5 absolute top-1/2 right-[calc(50%-450px)] transform -translate-y-1/2 bg-[#081f24] rounded-[40px] border border-solid border-[#081f241a] hover:bg-[#081f24]/90"
        aria-label="Next testimonial"
      >
        <ArrowRightIcon className="w-5 h-5" />
      </Button>

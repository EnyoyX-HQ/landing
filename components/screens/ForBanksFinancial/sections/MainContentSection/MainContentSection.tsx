        ...
        <div className="flex flex-col items-start gap-10 flex-1">
          <Card className="w-full border-none bg-transparent shadow-none">
            <CardContent className="flex flex-col items-start gap-4 p-0">
              <h3 className="self-stretch mt-[-1.00px] [font-family:'Bricolage_Grotesque',Helvetica] font-medium text-2xl md:text-[32px] leading-[28.8px] md:leading-normal text-[#081f24]">
                Streamlined Operations
              </h3>
              <p className="self-stretch [font-family:'Neue_Montreal-Regular',Helvetica] font-normal text-base md:text-lg leading-6 md:leading-7 text-[#081f24b2]">
          ...
          <Card className="w-full border-none bg-transparent shadow-none">
            <CardContent className="flex flex-col items-start gap-4 p-0">
              <h3 className="self-stretch mt-[-1.00px] [font-family:'Bricolage_Grotesque',Helvetica] font-medium text-2xl md:text-[32px] leading-[28.8px] md:leading-normal text-[#95f270]">
                Competitive Returns
              </h3>
              <p className="self-stretch [font-family:'Neue_Montreal-Regular',Helvetica] font-normal text-base md:text-lg leading-6 md:leading-7 text-[#081f24]">

...
export const SocialProofSection = (): JSX.Element => {
  ...
  return (
    <section className="w-[full] px-36 pt-0 pb-[100px] bg-white inline-flex flex-col justify-start items-start gap-10 overflow-hidden">
      ...
      <div className="w-[full] inline-flex justify-start items-center gap-5">
        {statistics.map((stat, index) => (
          <Card key={index} className="flex-1 h-auto px-10 py-20 bg-[#f8f6f2] rounded-[20px] border-none shadow-none">
